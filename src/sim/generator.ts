...
export function generateWorld(config: WorldConfig, onProgress?: GenerationProgressReporter): WorldState {
  ...
  const world: WorldState = {
    version: 35, language: 'ru', appVersion: APP_VERSION, config, name: `Мир ${placeName(rng)}`, year: config.historyYears, month: 1,
    tiles, kingdoms, settlements, settlementExpeditions: [], politicalCommunities: [], politicalTransitions: [], characters, relationships, dynasties, armies, battleRecords: [], militaryUnits: [], supplyWagons: [], armyCamps: [], armyCampStructures: [], armyLocalPositions: [], monsters, cemeteries: [], burials: [], animalPopulations, domesticHerds: [], ingredients, alchemyRecipes, artifacts, books, dungeons, wars, tradeRoutes, buildings: [], households: [], establishments: [], fields: [], constructionProjects: [], items: [], productionRecipes: [], employments: [], shipments: [], travelingMerchants: [], marketTransactions: [], financialTransactions: [], financialObligations: [], knowledgeFacts: [], memories: [], rumors: [], messages: [], settlementKnowledge: [], settlementTechnologyKnowledge: [], technologyTransmissions: [], resourceDeposits: [], settlementRegionalEconomies: [], tradeContracts: [], cultures: [], civilizations: [], languages: [], religions: [], settlementCultures: [], settlementGovernments: [], districtCivicStates: [], cityStates: [], urbanStates: [], civicPatrols: [], crimes: [], courtCases: [], fireIncidents: [], kingdomGovernments: [], nobleTitles: [], vassalContracts: [], courtOffices: [], courtFactions: [], royalOrders: [], stateCrises: [], diplomaticAgreements: [], socialObligations: [], healthConditions: [], pregnancies: [], epidemics: [], decisions: [], stateDeltas: [], institutionDecisions: [], territoryHistory: [], events, localMapChanges: [],
